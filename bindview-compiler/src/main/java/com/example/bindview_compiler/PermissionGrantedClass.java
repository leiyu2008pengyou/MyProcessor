...
public class PermissionGrantedClass implements MethodInterface{
    private Name mMethodName;
    public int[] ids;


    public PermissionGrantedClass(Element element) throws IllegalArgumentException {
        ...
        this.ids = methodElement.getAnnotation(PermissionGranted.class).value();
        if (ids == null) {
